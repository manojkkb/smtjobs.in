...
<div class="space-y-6">
    <header class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <h1 class="text-2xl font-semibold text-slate-900">Edit Skill</h1>
            <p class="text-sm text-slate-500">Update the master skill details below.</p>
        </div>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="flex items-center gap-4">
                    <label class="inline-flex items-center gap-2 text-sm font-medium text-slate-600">
                        ...
                        <input type="checkbox" name="is_active" value="1" class="h-4 w-4 rounded border-slate-300 text-slate-900" @checked(old('is_active', $skill->is_active))>
                        Active
                    </label>
