...
@section('title', 'Create Work Mode')
...
<div class="space-y-6">
    <header class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <h1 class="text-2xl font-semibold text-slate-900">Create Work Mode</h1>
            <p class="text-sm text-slate-500">Add a new work mode that captures how candidates can show up for work.</p>
        </div>
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <form action="{{ route('admin.work-modes.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p class="text-xs text-slate-400">Visible to job builders when enabled.</p>
                </div>
            </div>
