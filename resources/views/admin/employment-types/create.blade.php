...
<div class="space-y-6">
    <header class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <h1 class="text-2xl font-semibold text-slate-900">Create Employment Type</h1>
            <p class="text-sm text-slate-500">Add a new employment type to classify how roles are offered.</p>
        </div>
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <form action="{{ route('admin.employment-types.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p class="text-xs text-slate-400">Visible to employers when enabled.</p>
                </div>
            </div>
