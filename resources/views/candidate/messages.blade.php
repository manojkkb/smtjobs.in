                        ...
                        <div class="rounded-xl sm:rounded-2xl border border-slate-200 bg-white flex flex-col h-[70vh]">
                                    ...
                                    <div class="flex {{ $isSender ? 'justify-end' : 'justify-start' }}" data-message-id="{{ $message->id }}">
                                        <div class="max-w-[75%] sm:max-w-[70%]">
                                            ...
                                            @elseif(str_starts_with($message->type, 'request_') && !$isSender)
                                                <div class="rounded-xl sm:rounded-2xl px-3 sm:px-4 py-2 sm:py-3 bg-blue-50 border border-blue-200">
                                                    ...
                                                    <p class="text-sm sm:text-base break-words text-slate-900 mb-3">{{ $message->message }}</p>
                                                    @if($message->request_status === 'pending')
                                            ...
                                            @elseif(str_starts_with($message->type, 'request_') && $isSender)
                                                <div class="rounded-xl sm:rounded-2xl px-3 sm:px-4 py-2 sm:py-3 bg-purple-50 border border-purple-200">
                                            ...
                                            @elseif(str_contains($message->type, '_response'))
                                                <div class="rounded-xl sm:rounded-2xl px-3 sm:px-4 py-2 sm:py-3 {{ $isSender ? 'bg-green-50 border border-green-200 text-slate-900' : 'bg-slate-900 text-white' }}">
                            ...
                            <div class="border-t border-slate-200 p-4 flex-shrink-0">
                                ...
                                <div class="flex gap-2 mb-3 flex-wrap">
                                    ...
                                    <button type="button" onclick="sendRequest('request_location')" class="text-xs sm:text-sm px-3 py-1.5 rounded-lg bg-amber-50 text-amber-700 hover:bg-amber-100 transition border border-amber-200 flex items-center gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
