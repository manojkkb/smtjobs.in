		...
		<div class="grid gap-8 sm:gap-10 grid-cols-2 md:grid-cols-2 lg:grid-cols-5">
			...
			<div class="space-y-4">
				...
				<ul class="space-y-3 text-slate-300">
					...
					<li><a href="<?php echo e(route('browse-jobs')); ?>" class="inline-flex items-center gap-2 transition-all hover:text-white hover:translate-x-1">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
						</svg>
						Browse Jobs
					</a></li>
					<li><a href="<?php echo e(route('view-all')); ?>" class="inline-flex items-center gap-2 transition-all hover:text-white hover:translate-x-1">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
						</svg>
						View All Jobs
			...
			<div class="space-y-4">
				...
				<ul class="space-y-3 text-slate-300">
					<li><a href="<?php echo e(route('recruiter.job-posts.create')); ?>" class="inline-flex items-center gap-2 transition-all hover:text-white hover:translate-x-1">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
						</svg>
						Post a Job
					</a></li>
					<li><a href="<?php echo e(route('recruiter.dashboard')); ?>" class="inline-flex items-center gap-2 transition-all hover:text-white hover:translate-x-1">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
						</svg>
						Employer Dashboard
...
<?php /**PATH D:\smtjobs\resources\views/website/layouts/footer.blade.php ENDPATH**/ ?>